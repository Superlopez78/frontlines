...
init()
{
	...
	maps\mp\gametypes\_globallogic::registerTimeLimitDvar( level.gameType, 6, 0, 1440 );
	maps\mp\gametypes\_globallogic::registerScoreLimitDvar( level.gameType, 6, 0, 500 );
